...
// Sections
const bodyBackgroundImage = $('#bodyBackground');
const headerSection = $('#header');
const mainSection = $('#main');
const trendingSection = $('#trendingPreview');
const categoriesSection = $('#categoriesPreview');
const upcomingSection = $('#upcomingPreview');
